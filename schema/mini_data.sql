insert into person values(0,'Admin','IITB',123456,1234567890,'M','Ramu0','Ramu0','foo@gmail.com','2000-01-01','Btech');
insert into person values(1,'P0','IITB',123456,1234567890,'M','Ramu1','Ramu1','foo@gmail.com','2000-01-01','Btech');
insert into person values(2,'P1','IITB',123456,1234567890,'M','Ramu2','Ramu2','foo@gmail.com','2000-01-01','Btech');
insert into person values(3,'P2','IITB',123456,1234567890,'M','Ramu3','Ramu3','foo@gmail.com','2000-01-01','Btech');
insert into person values(4,'D1','IITB',123456,1234567890,'M','Ramu4','Ramu4','foo@gmail.com','2000-01-01','Btech');
insert into person values(5,'D2','IITB',123456,1234567890,'M','Ramu5','Ramu5','foo@gmail.com','2000-01-01','Btech');
insert into person values(6,'S1','IITB',123456,1234567890,'M','Ramu6','Ramu6','foo@gmail.com','2000-01-01','Btech');
insert into person values(7,'S2','IITB',123456,1234567890,'M','Ramu7','Ramu7','foo@gmail.com','2000-01-01','Btech');
insert into person values(8,'S3','IITB',123456,1234567890,'M','Ramu8','Ramu8','foo@gmail.com','2000-01-01','Btech');
insert into person values(9,'S4','IITB',123456,1234567890,'M','Ramu9','Ramu9','foo@gmail.com','2000-01-01','Btech');
